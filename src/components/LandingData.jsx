      ...
      <div className="w-full lg:w-1/2 ">
        <div className="bg-[#FAFCFE] border-2 border-[#afccea] rounded-2xl p-5 md:p-3 lg:p-6">
          ...
          <div className="flex flex-col gap-3">
            {/* first product  */}
            <div className="flex flex-col md:flex-row items-center justify-around lg:gap-16 bg-[#FFFFFF] py-4 px-5 border-[1px] border-[#D1E1FA] rounded-2xl">
              <img src="/images/phone2.png" alt="" />
              <div className="text-[#081F45] text-center ">
                <h1 className="text-3xl font-bold ">Apple Watch </h1>
                <p className="text-xl md:text-lg xl:text-xl">with dual-frequency</p>
              </div>
              <div className="flex 2xl:flex-row flex-col gap-4">
              <h1 className="text-4xl text-[#EB9947] font-extrabold ">€500</h1>
              <button className="py-3 px-5 text-white bg-[#EB9947] rounded-xl text-sm lg:text-xs">Sell now</button>
              </div>
            </div>
            {/* second product  */}
            <div className="flex flex-col md:flex-row items-center justify-around lg:gap-16 bg-[#FFFFFF] py-4 px-5 border-[1px] border-[#D1E1FA] rounded-2xl">
