...
const Nevo = () => {
    ...
    const handleLanguageChange = (language) => {
      ...
      setIsOpen(false);
      // You can perform any language change action here
    };
    ...
    return (
      ...
      <button
        ...
        className="flex items-center gap-2 space-x-1  text-gray-800 px-3 py-2 rounded-md "
      >
        {/* Add dynamic SVG icon based on selected language */}
        {selectedLanguage === 'Urdu (PK)' && (
       <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
       <rect x="1" y="4" width="30" height="24" rx="2" ry="2" fill="#173e1b"></rect>
       ...
       <path fill="#fff" d="M22.984 13.282L23.153 14.997 24.024 13.51 25.708 13.879 24.563 12.591 25.434 11.104 23.855 11.795 22.71 10.507 22.88 12.222 21.301 12.913 22.984 13.282z"></path>
        ...
        {selectedLanguage === 'Arabic (UAE)' && (
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
          <rect x="1" y="4" width="30" height="24" rx="2" ry="2" fill="#215230"></rect>
          <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path>
          <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path>
        ...
        {isOpen ? <IoMdArrowDropup  className='rotate-180'/> : <IoMdArrowDropup/> }
      </button>
      ...
      {isOpen && (
        <div className="absolute z-10 mt-2 w-48  rounded-md shadow-lg">
          <ul className="py-1">
            <li>
              <button
                onClick={() => handleLanguageChange('Urdu (PK)')}
            ...
            <li>
              <button
                onClick={() => handleLanguageChange('Arabic (UAE)')}
                className="block px-4 py-2 text-gray-800  w-full text-left"
              >
